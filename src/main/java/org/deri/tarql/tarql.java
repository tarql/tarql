...
import org.deri.tarql.functions.currency;
import org.deri.tarql.functions.date;
import org.deri.tarql.functions.dateTime;
...
public class tarql extends CmdGeneral {
    ...
    /**
     * Add here all the functions to register. This needs to be called before the query parsing. <p/> <a
     * href="https://jena.apache.org/documentation/query/writing_functions.html"></a>
     */
    public void registerFunctions() {
        // Register with the global registry.
        FunctionRegistry.get().put("http://tarql.github.io/tarql#date", date.class);
        FunctionRegistry.get().put("http://tarql.github.io/tarql#date-time", dateTime.class);
        FunctionRegistry.get().put("http://tarql.github.io/tarql#currency", currency.class);
    }
